...
#### Що робити, якщо uplink порт не піднімається, хоча оптичні показники в нормі?
У випадку, коли pon-zte має uplink 10G і включена в 1G порт потрібно змінити швидкість на 1G на xgei-1/1/1 - xgei-1/1/4 портах. Тобто, щоб працював ОДИН uplink порт, потрібно щоб швидкість була однакова на 4 портах. negotioation не чіпаємо, має бути is force.
1. Заходимо на кожен інтерфейс xgei-1/1/x(x - 1,2,3,4) і прописуємо speed speed-1G.
2. Виходимо з конфігураційного режиму і зберігаємо - write.
Після цього uplink порт має піднятись.
...
Натискаємо вкладку Restore to NE  
Ставимо галочку на бекапі, який хочемо відновити (Backup Time – щоденний бекап, останній з смого верху, по даті все видно)  
Start -> Yes  
