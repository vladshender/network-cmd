...
- **Адміністративне закриття / відкриття інтерфейсу**: 
    ```bash
    configure
            Перед закриттям інтерфейсу знімаємо захист
    unprotect interfaces xe-2/0/1

    set interface xe-0/0/0 disable - адміністративне закриття порту
    del interface xe-0/0/0 disable - адміністративне відкриття порту
    
            І після усунення аварії на інтерфейсі повернути захист
    protect interfaces xe-2/0/1
     ```



## Перевірка абонента НЕ DHCP (PROF/L3)
